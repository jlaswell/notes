...
var RootCmd = &cobra.Command{
	Use:   "notes",
	Short: "A simple note taking utility",
	Long: `notes is a simple note taking utility that was developed for simplicity and ease.

It focuses on a minimal api using existing tools to simplify note taking.`,
}
